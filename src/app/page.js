...
export default function Home() {
  return (
    <main className="bg-[url('/background.svg')] bg-auto w-full h-full flex flex-col justify-center items-center mobile:justify-start mobile:bg-none mobile:bg-[#313338] mobile:py-5 mobile:px-4">
      <div className="top-12 left-12 fixed mobile:static mobile:mb-4">
